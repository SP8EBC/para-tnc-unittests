...
#ifndef MEMORY_MAP____MEMORY_MAP_H_
#define MEMORY_MAP____MEMORY_MAP_H_
...
/**
 * How many events fits in one page of emulated flash page
 */
...
#endif /* MEMORY_MAP____MEMORY_MAP_H_ */
